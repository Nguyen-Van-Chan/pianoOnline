...
<template>
  ...
  >
        ...
        <div class="piano-key-wrap">
          ...
          <div class="bkey-wrap bkey-wrap2">
            <div
              ...
              :data-keyCode="note.keyCode"
              :data-name="note.name"
              v-if="note.type == 'black' && note.id >= 41 && note.id <= 45"
              @click.stop="clickPianoKey($event, note.keyCode)"
            >
              <div class="keytip">
                <div
          ...
          <div class="bkey-wrap bkey-wrap3">
            <div
              ...
              :data-keyCode="note.keyCode"
              :data-name="note.name"
              v-if="note.type == 'black' && note.id >= 46 && note.id <= 50"
              @click.stop="clickPianoKey($event, note.keyCode)"
            >
              <div class="keytip">
                <div
          ...
          <div class="bkey-wrap bkey-wrap4">
            <div
              ...
              :data-keyCode="note.keyCode"
              :data-name="note.name"
              v-if="note.type == 'black' && note.id >= 51 && note.id <= 55"
              @click.stop="clickPianoKey($event, note.keyCode)"
            >
              <div class="keytip">
                <div
          ...
          <div class="bkey-wrap bkey-wrap5">
            <div
              ...
              :data-keyCode="note.keyCode"
              :data-name="note.name"
              v-if="note.type == 'black' && note.id >= 56 && note.id <= 60"
              @click.stop="clickPianoKey($event, note.keyCode)"
            >
              <div class="keytip">
                <div
    ...
    >Trình duyệt của bạn không hỗ trợ
      <pre>Canvas</pre>。Vui lòng nâng cấp lên phiên bản mới nhất của các trình duyệt như Chrome, Firefox, Edge.
    </canvas>
    ...
    $currentNote(newNote) {
      if (newNote) {
        ...
        if (note) {
          ...
          keyElement.addClass('auto-key-active')
